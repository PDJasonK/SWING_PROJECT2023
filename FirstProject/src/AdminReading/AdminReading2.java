...
public class AdminReading2 extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
	...
	AdminReading2DAO dao = new AdminReading2DAO();
	...
	public AdminReading2() {
		...
		title = new JLabel("[Second Parapgraphs]이전에 입력했던 내용확인");
...
//	     f.getContentPane().add(btn2);
	...
	public static void main(String[] args) {
		AdminReading2 AM = new AdminReading2();
		AM.startframe();
	}
...
*/
				gain1.setText(rs2.getString("gain1"));
