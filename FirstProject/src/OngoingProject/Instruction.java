...
// 		frame.setLayout(new FlowLayout());
		...
		JTextArea txtI = new JTextArea("-page 1 -");
//-------------------------------------------------------------------------------------------------
...
//		txtA.setSize(10, 5);
		...
		txtF.setFont(new Font("Gothic", Font.BOLD, 13));
		txtD.setFont(new Font("Gothic", Font.BOLD, 13));
		txtH.setFont(new Font("Gothic", Font.BOLD, 13));
//-----------------------------------------------------
		...
		JButton tbn0 = new JButton("뒤로 돌아가기");
