...
public class VocabToeic2Send extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
...
//	private JLabel PContent2;
	...
	VocabToeic2SendDAO dao = new VocabToeic2SendDAO();
	...
	public VocabToeic2Send() {
		...
		title = new JLabel("단어메인두뻥쨰 [Vocab List] ");
