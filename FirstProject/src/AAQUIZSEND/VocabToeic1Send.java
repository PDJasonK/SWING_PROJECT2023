...
public class VocabToeic1Send extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
...
//	private JLabel PContent2;
	...
	VocabToeic1SendDAO dao = new VocabToeic1SendDAO();
	 ...
	 * sm.startframe(); }
	 */
	public VocabToeic1Send() {

		f = new JFrame("Voca Moka");
		p = new JPanel();
		p.setLayout(null);

		// -----

		title = new JLabel("단어메인처뻥쨰 [Vocab List] ");
...
//		Output1.setEditable(false);
		...
		/*
		 * PContent2 = new JLabel("두번째 문단의 해석문", JLabel.LEFT); PContent2.setBounds(30,
		 * 380, 500, 500); PContent3 = new JLabel("세번째 첫번째 문단의 해석문 ", JLabel.LEFT);
		 * PContent3.setBounds(30, 520, 500, 500);
		 * 
		 * Input1 = new JTextArea(); Input1.setBounds(30, 680, 800, 180 );
		 * Input1.addFocusListener(new FocusAdapter() { public void
		 * focusGained(FocusEvent e) { Input1.setBackground(Color.ORANGE); }
		 * 
		 * @Override public void focusLost(FocusEvent e) {
		 * Input1.setBackground(Color.YELLOW); } });
		 */
		/*
		 * Input2 = new JTextArea(); Input2.setBounds(30, 640, 50, 90);
		 * Input2.addFocusListener(new FocusAdapter() { public void
		 * focusGained(FocusEvent e) { Input2.setBackground(Color.ORANGE); }
		 * 
		 * @Override public void focusLost(FocusEvent e) {
		 * Input2.setBackground(Color.YELLOW); } });
		 * 
		 * Input3 = new JTextArea(); Input3.setBounds(30, 780, 50, 90);
		 * Input3.addFocusListener(new FocusAdapter() { public void
		 * focusGained(FocusEvent e) { Input3.setBackground(Color.ORANGE); }
		 * 
		 * @Override public void focusLost(FocusEvent e) {
		 * Input3.setBackground(Color.YELLOW); } });
		 * 
		 * Input4 = new JTextArea(); Input4.setBounds(90, 500, 50, 90);
		 * Input4.addFocusListener(new FocusAdapter() { public void
		 * focusGained(FocusEvent e) { Input4.setBackground(Color.ORANGE); }
		 * 
		 * @Override public void focusLost(FocusEvent e) {
		 * Input4.setBackground(Color.YELLOW); } });
		 * 
		 * Input5 = new JTextArea(); Input5.setBounds(90, 640, 50, 90);
		 * Input5.addFocusListener(new FocusAdapter() { public void
		 * focusGained(FocusEvent e) { Input5.setBackground(Color.ORANGE); }
		 * 
		 * @Override public void focusLost(FocusEvent e) {
		 * Input5.setBackground(Color.YELLOW); } });
		 * 
		 * Input6 = new JTextArea(); Input6.setBounds(90, 780, 50, 90);
		 * Input6.addFocusListener(new FocusAdapter() { public void
		 * focusGained(FocusEvent e) { Input6.setBackground(Color.ORANGE); }
		 * 
		 * @Override public void focusLost(FocusEvent e) {
		 * Input6.setBackground(Color.YELLOW); } });
		 * 
		 * 
		 * Input7 = new JTextArea(); Input7.setBounds(150, 500, 50, 90);
		 * Input7.addFocusListener(new FocusAdapter() { public void
		 * focusGained(FocusEvent e) { Input7.setBackground(Color.ORANGE); }
		 * 
		 * @Override public void focusLost(FocusEvent e) {
		 * Input7.setBackground(Color.YELLOW); } });
		 * 
		 * Input8 = new JTextArea(); Input8.setBounds(150, 640, 50 ,90);
		 * Input8.addFocusListener(new FocusAdapter() { public void
		 * focusGained(FocusEvent e) { Input8.setBackground(Color.ORANGE); }
		 * 
		 * @Override public void focusLost(FocusEvent e) {
