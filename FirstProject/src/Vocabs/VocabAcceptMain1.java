...
public class VocabAcceptMain1 extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
/*
	...
	*/
	...
	public VocabAcceptMain1() {
		
		f = new JFrame("Maybe First ONe");
		p = new JPanel();
		p.setLayout(null);
...
/*		p.add(PContent1);
	...
	*/	
	...
	public static void main(String[] args) {
		VocabAcceptMain1 sm = new VocabAcceptMain1();
		sm.startframe();
	}
	...
	public void method() {
		...
		try {
			...
			String sql2 = "SELECT Output1, Output2, Output3, Output4, Output5, Output6, Output7, Output8, Output9, Output10, Output11, Output12 , Output13 ,Output14 ,Output15 ,Output16 FROM VocabOut1";
