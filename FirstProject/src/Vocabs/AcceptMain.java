...
public class AcceptMain extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
/*
	...
	*/	p.add(Submit);
	...
	public void method() {
		...
		try {
			...
			String sql2 = "SELECT Output1, Output2, Output3, Output4, Output5, Output6, Output7, Output8, Output9, Output10, Output11, Output12 , Output13 ,Output14 ,Output15 ,Output16 FROM VocabOut";
