...
public class VocabToeic3MainOutDAO {
	...
	public ArrayList<VocabToeic3MainOutVo> list(String Output1, String Output2, String Output3, String Output4,
		...
		ArrayList<VocabToeic3MainOutVo> list = new ArrayList<VocabToeic3MainOutVo>();
		try {
