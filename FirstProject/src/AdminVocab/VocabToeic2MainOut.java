...
public class VocabToeic2MainOut extends WindowAdapter implements ActionListener {
	private JFrame f;
	private JPanel p;
...
//	private JLabel PContent2;
	...
	VocabToeic2MainOutDAO dao = new VocabToeic2MainOutDAO();
	 ...
	 * sm.startframe(); }
	 */
	public VocabToeic2MainOut() {
		
		f = new JFrame("Voca Moka2");
		p = new JPanel();
		p.setLayout(null);
