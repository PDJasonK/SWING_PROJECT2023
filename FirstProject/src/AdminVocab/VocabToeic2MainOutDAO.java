...
public class VocabToeic2MainOutDAO {
	...
	public ArrayList<VocabToeic2MainOutVo> list(String Output1, String Output2, String Output3, String Output4,
		...
		ArrayList<VocabToeic2MainOutVo> list = new ArrayList<VocabToeic2MainOutVo>();
		try {
...
//				" and contentsC = '" + contents3.toLowerCase() + "'";
			query = "insert into VocabOut2(Output1, Output2,Output3,Output4,Output5,Output6,Output7,Output8 , Output9 , Output10 , Output11 , Output12 , Output13 , Output14 , Output15 , Output16) "
